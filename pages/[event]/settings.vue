<template>
    <article class="settings">
        ...
        <fieldset v-if="cloud.eventDescription?.transfers">
            ...
            <div>
                <NuxtLink id="transfer" :to="`/${cloud.selectedEvent}/transfer/here`" class="nowrap inline-block">
                    <Icon name="mdi:download" />&nbsp;Přenést sem
                </NuxtLink>
                <NuxtLink :to="`/${cloud.selectedEvent}/transfer/away`" class="nowrap inline-block ml-1">
        ...
        <fieldset>
            ...
            <div>
                <button
                    v-if="deleteResult !== true" title="Smazání mého feedbacku a poznámek"
        ...
        <fieldset>
            <NuxtLink :to="`/${cloud.selectedEvent}/about`">O aplikaci</NuxtLink>
        </fieldset>
    </article>
</template>
