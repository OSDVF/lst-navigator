...
const config = defineNuxtConfig({
    ...
    runtimeConfig: {
        public: {
            registrationDefaultCurrency: process.env.REGISTRATION_DEFAULT_CURRENCY,
            registrationDefaultBankCode: process.env.REGISTRATION_DEFAULT_BANK_CODE,
            registrationDefaultAccount: process.env.REGISTRATION_DEFAULT_ACCOUNT,
            registrationDefaultDonationSymbol: process.env.REGISTRATION_DEFAULT_DONATION_SYMBOL,
            registrationDefaultArrivalField: process.env.REGISTRATION_DEFAULT_ARRIVAL_FIELD,
            registrationDefaultDepartureField: process.env.REGISTRATION_DEFAULT_DEPARTURE_FIELD,
            registrationDefaultNameField: process.env.REGISTRATION_DEFAULT_NAME_FIELD,
            registrationDefaultExtrasField: process.env.REGISTRATION_DEFAULT_EXTRAS_FIELD,
            registrationDefaultCategoryField: process.env.REGISTRATION_DEFAULT_CATEGORY_FIELD,
            registrationDefaultPhoneField: process.env.REGISTRATION_DEFAULT_PHONE_FIELD,
            registrationDefaultFirstMealField: process.env.REGISTRATION_DEFAULT_FIRST_MEAL_FIELD,
            registrationDefaultEventFirstMealIndex: process.env.REGISTRATION_DEFAULT_EVENT_FIRST_MEAL_INDEX || '0',
            registrationDefaultLastMealField: process.env.REGISTRATION_DEFAULT_LAST_MEAL_FIELD,
            registrationDefaultEventLastMealIndex: process.env.REGISTRATION_DEFAULT_EVENT_LAST_MEAL_INDEX || (process.env.REGISTRATION_DEFAULT_MEAL_NAMES?.split(',')?.length ?? 0).toString(),
            registrationDefaultFoodField: process.env.REGISTRATION_DEFAULT_FOOD_FIELD,
            registrationDefaultTownField: process.env.REGISTRATION_DEFAULT_TOWN_FIELD,
            registrationDefaultMealNames: process.env.REGISTRATION_DEFAULT_MEAL_NAMES,
            registrationFormApi: process.env.APPLICATION_FORM_API,
            registrationFormExecutive: process.env.APPLICATION_FORM_EXECUTIVE,
